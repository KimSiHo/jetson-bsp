...
#define NVGSTDS_LINK_ELEMENT(elem1, elem2)                                                                             \
	do {                                                                                                               \
		if (!gst_element_link(elem1, elem2)) {                                                                         \
			...
			NVGSTDS_ERR_MSG_V("Failed to link '%s' (%s) and '%s' (%s)", GST_ELEMENT_NAME(elem1),                       \
			                  gst_caps_to_string(src_caps), GST_ELEMENT_NAME(elem2), gst_caps_to_string(sink_caps));   \
			goto done;                                                                                                 \
		}                                                                                                              \
	} while (0)
...
// Function to link source pad of an element to sink pad (index) of muxer
// element .
...
// Function to link sink pad of an element to source pad (index) of demux
// element.
